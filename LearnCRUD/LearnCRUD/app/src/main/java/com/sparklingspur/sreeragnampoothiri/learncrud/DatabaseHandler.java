...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public List<Contact> getAllContacts(){
        ...
        if(curser.moveToFirst()){
            do{
                ...
                contact.setId(Integer.parseInt(curser.getString(0)));
                contact.setName(curser.getString(1));
                contact.setPhoneNumber(Integer.parseInt(curser.getString(2)));
    ...
    public void deleteContants(Contact contact){
        SQLiteDatabase db = this.getWritableDatabase();
